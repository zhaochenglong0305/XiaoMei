...
public class BankInfo {
    ...
    private static final String[] bankName = {
            ...
            "遂宁市商业银行·锦程卡", "遂宁市商业银行·金荷卡", "保定银行·直隶卡", "保定银行·直隶卡", "凉山州商业银行·锦程卡", "凉山州商业银行·金凉山卡", "漯河银行·福卡", "漯河银行·福源卡", "漯河银行·福源公务卡",
    ...
    public static String getNameOfBank(char[] charBin, int offset) {
        ...
        String idCard = String.valueOf(charBin);
        int index = -1;
        ...
        for (int i = 0; i < bankBin.length; i++) {
            if (cardbin_6.equals(String.valueOf(bankBin[i]))) {
                index = i;
            }
        }
        if (index != -1) {
        ...
        for (int i = 0; i < bankBin.length; i++) {
            if (cardbin_8.equals(String.valueOf(bankBin[i]))) {
                index = i;
            }
        }
        if (index != -1) {
