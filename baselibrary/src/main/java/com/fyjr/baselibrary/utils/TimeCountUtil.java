...
public class TimeCountUtil extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        //设置按钮为灰色，这时是不能点击的
//        btn.setBackgroundColor(ContextCompat.getColor(mActivity.getBaseContext(), R.color.gray));
...
//        btn.setBackground(ContextCompat.getDrawable(mActivity.getBaseContext(), R.drawable.hehe));//还原背景色
