...
public class ImageSelectorActivity extends AppCompatActivity {
    ...
    public static void clear() {
        ImageListAdapter.selectImages.clear();
    }

    public static void remove(int id){
        ImageListAdapter.selectImages.remove(id);
    }
    ...
    public void initView() {
        ...
        updateView(ImageListAdapter.selectImages);
    }
    ...
    private void updateView(List<LocalMedia> selectImages) {
        ...
        try {
            ...
            if (cameraIntent.resolveActivity(getPackageManager()) != null) {
                ...
                if (Build.VERSION.SDK_INT >= 24) {
                    ...
                    Uri contentUri = FileProvider.getUriForFile(this, "com.fyjr.winesocial.fileProvider", cameraFile);
    ...
    public void startPreview(List<LocalMedia> previewImages, int position) {
        ImagePreviewActivity.startPreview(this, previewImages, imageAdapter.getSelectedImages(), maxSelectNum, position, true);
    }
