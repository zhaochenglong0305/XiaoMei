...
public class ImagePreviewActivity extends AppCompatActivity {
    ...
    public static void startPreview(Activity context, List<LocalMedia> images, List<LocalMedia> selectImages, int maxSelectNum, int position, boolean isOperate) {
...
//        intent.putExtra(EXTRA_PREVIEW_SELECT_LIST, (ArrayList) selectImages);
        ...
        intent.putExtra(IS_OPERATE, isOperate);
...
//        selectImages = (List<LocalMedia>) getIntent().getSerializableExtra(EXTRA_PREVIEW_SELECT_LIST);
        images = ImageListAdapter.images;
        selectImages = ImageListAdapter.selectImages;
        maxSelectNum = getIntent().getIntExtra(EXTRA_MAX_SELECT_NUM, 9);
        position = getIntent().getIntExtra(EXTRA_POSITION, 1);
        isOperate = getIntent().getBooleanExtra(IS_OPERATE, true);
    ...
    public class SimpleFragmentAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return ImagePreviewFragment.getInstance(images.get(position).getPath(), isOperate);
        }
